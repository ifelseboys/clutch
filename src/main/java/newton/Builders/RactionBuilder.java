...
public class RactionBuilder {
    public static IReaction build(String reactionType, HashMap<String, String> variables) throws InvalidRactionInformation {
        try{
            ...
            throw new InvalidRactionInformation();
        }
    }


    public static IReaction buildCommandExecutor(HashMap<String, String> variables) throws InvalidRactionInformation {
    ...
    public static IReaction buildFileOpener(HashMap<String, String> variables) throws InvalidRactionInformation {
    ...
    public static IReaction buildNotification(HashMap<String, String> variables) throws InvalidRactionInformation {
